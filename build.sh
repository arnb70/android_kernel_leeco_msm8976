...
# Custom build script for PureCAF Kernel
...
# Define variables
KERNEL_DIR=$PWD
Anykernel_DIR=$KERNEL_DIR/ak3/
DATE=$(date +"%d%m%Y")
TIME=$(date +"-%H.%M.%S")
KERNEL_NAME="PureCAF+[OC]"
DEVICE="-COOL1-"
...
export KBUILD_BUILD_HOST="c1"
export CROSS_COMPILE=/home/arnabpal70/kernel/gcc/aarch64-linux-gnu/bin/aarch64-linux-gnu-
export ARCH="arm64"
export USE_CCACHE=1
